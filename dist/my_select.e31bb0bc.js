...
var getTemplate = function getTemplate() {
  ...
  var isSelect = false;
  var itemsHTML = data.map(function (i) {
    isSelect = false;
    ...
    return "\n            <li class=\"select__item ".concat(isSelect ? 'selected' : '', "\" data-type=\"item\" data-value=").concat(i.id, ">").concat(i.value, "</li>");
  });
  return "\n     <div class=\"select__input\" data-type=\"input\">\n                <span data-type=\"valueSelect\">".concat(text, "</span>\n                <i class=\"fa fa-chevron-down\" data-type=\"downOrUp\" ></i>\n            </div>\n            <div id=\"openAndClose\" class=\"select__dropdown\">\n                <ul class=\"select__list\">\n                    ").concat(itemsHTML.join(''), "\n                </ul>\n            </div>\n        </div>\n    ");
};

var _render = /*#__PURE__*/new WeakSet();

var _openWin = /*#__PURE__*/new WeakSet();

var Select = /*#__PURE__*/function () {
  function Select(selector, options) {
    _classCallCheck(this, Select);

    _classPrivateMethodInitSpec(this, _openWin);
    ...
    _classPrivateMethodGet(this, _openWin, _openWin2).call(this);
  }
  ...
  _createClass(Select, [{
    ...
    key: "itemInDataSelected",
    get: function get() {
      var _this = this;

      return this.options.data.find(function (i) {
        return i.id === _this.selectId;
      });
    }
  }, {
    key: "select",
    value: function select(id) {
      var item = this.$el.querySelector("[data-value=\"".concat(this.selectId, "\"]"));
      if (this.selectId != null) item.classList.remove("selected");
      this.selectId = id;
      this.$valueSelect.textContent = this.itemInDataSelected.value;
      item = this.$el.querySelector("[data-value=\"".concat(id, "\"]"));
    ...
    key: "isOpen",
    get: function get() {
      var open = document.querySelector('#openAndClose');
...
},{"./bundle-url":"C:/Users/admin/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"select/style.css":[function(require,module,exports) {
...
window.s = select;
},{"./select/select":"select/select.js","./select/style.css":"select/style.css"}],"C:/Users/admin/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/my_select.e31bb0bc.js.map